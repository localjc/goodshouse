...
public class BaseListFragment extends BaseLoadingFragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public static BaseListFragment newFragment(String type) {
